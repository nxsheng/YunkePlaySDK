...
public class TableLayoutBinder {
    ...
    public TableLayoutBinder(Context context) {
        this(context, UIHelper.getResIdByName(context, UIHelper.TYPE_LAYOUT, "yunke_table_media_info"));
    }
    ...
    public TableLayoutBinder(Context context, int layoutResourceId) {
        ...
        mTableLayout = (TableLayout) mTableView.findViewById(UIHelper.getResIdByName(context, UIHelper.TYPE_ID, "table"));
    }
    ...
    public View appendRow1(String name, String value) {
        return appendRow(UIHelper.getResIdByName(mContext, UIHelper.TYPE_LAYOUT, "yunke_table_media_info_row1"), name, value);
    }
    ...
    public View appendRow2(String name, String value) {
        return appendRow(UIHelper.getResIdByName(mContext, UIHelper.TYPE_LAYOUT, "yunke_table_media_info_row2"), name, value);
    }
    ...
    public View appendSection(String name) {
        return appendRow(UIHelper.getResIdByName(mContext, UIHelper.TYPE_LAYOUT, "yunke_table_media_info_section"), name, null);
    }
    ...
    public ViewHolder obtainViewHolder(View rowView) {
        ...
        if (viewHolder == null) {
            ...
            viewHolder.mNameTextView = (TextView) rowView.findViewById(UIHelper.getResIdByName(mContext, UIHelper.TYPE_ID, "name"));
            viewHolder.mValueTextView = (TextView) rowView.findViewById(UIHelper.getResIdByName(mContext, UIHelper.TYPE_ID, "value"));
